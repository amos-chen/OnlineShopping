(function($) {
    ...
    function switchAction(id, open) {
        ...
        if(open) {
            $(".select2-results__options li[val=" + id + "] span[class]:eq(0)").removeClass("fa fa-folder fa-fw").addClass("fa fa-folder-open fa-fw");
            $(".select2-results__options li[parent='" + id + "']").slideDown();
        } else {
            $(".select2-results__options li[val=" + id + "] span[class]:eq(0)").removeClass("fa fa-folder-open fa-fw").addClass("fa fa-folder fa-fw");
    ...
    function open() {
        setTimeout(function() {
            ...
            $(".select2-results__options li").each(function() {
                ...
                if($this.attr("parent")) {
                    $(this).siblings("li[val=" + $this.attr("parent") + "]").find("span:eq(0)").addClass("fa fa-folder-open fa-fw switch").css({
                        // "padding": "0 10px",
                        "cursor": "default"
                    });
            ...
            $(".switch").mousedown(function() {
                switchAction($(this).parent().attr("val"), $(this).hasClass("fa-folder"));
